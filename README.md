the apis designed in python relates to stocks project, it includes show all data api, get single company stock data, and calculate the cumulative retures
